...
### Table : employee_attrition_dataset
- id_employee : INTEGER
- age : INTEGER
- genre : TEXT
...
## Rôle des tables
- `employee_attrition_dataset` : contient le dataset complet utilisé par le projet.
- `predictions` : contient les inputs et outputs des prédictions faites via l’API afin d’assurer la traçabilité.